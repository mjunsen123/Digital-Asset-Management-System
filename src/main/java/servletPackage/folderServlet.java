...
public class folderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String masterPath = digitalFiles.masterPath();

            //check whether is navigate by table row or back button
            ...
            } else if (request.getParameter("backPath") != null) {
                path = masterPath + request.getParameter("backPath");
                if (!path.equals(masterPath+email)) {
